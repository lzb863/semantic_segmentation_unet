...
if __name__ == '__main__':
    ...
    parser.add_argument('--list_train',
                        default='./data/train_bdd.odgt')
    parser.add_argument('--list_val',
                        default='./data/val_bdd.odgt')
    parser.add_argument('--root_dataset',
                        default='/home/teai/externalhd2/BDD100K/segmentation_v2/')
    ...
    parser.add_argument('--epoch_iters', default=4911, type=int,
    ...
    parser.add_argument('--imgSize', default=[300, 375, 450, 525, 600],
                        nargs='+', type=int,
                        help='input image size of short edge (int or list)') #[300, 375, 450, 525, 600]
