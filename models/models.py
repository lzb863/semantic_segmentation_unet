    ...
    def forward(self, feed_dict, *, segSize=None):
        ...
        if segSize is None:
            if self.deep_sup_scale is not None: # use deep supervision technique
                #print("feed dict img data : ",feed_dict)
#                 var = self.encoder(feed_dict[0]['img_data'].cuda())
#                 print("input to encoder :",feed_dict[0]['img_data'].shape)
#                 print("encoder output : ",var[0].shape)
...
#             print("length of feed dict : ",len(feed_dict))
#             print("pred : ",pred.shape)
#             print("input seg_label shape : ",feed_dict[0]['seg_label'].shape)
#             print("input img_data shape : ",feed_dict[0]['img_data'].shape)
